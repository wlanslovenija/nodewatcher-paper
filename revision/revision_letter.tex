...
\vspace{0.5cm}\noindent\textsc{Response}\\
It is true that the system will actively validate current node configuration with the preconfigured one and emit warnings in case there are mismatches.
