...
\begin{itemize}
\item Created Section 3.2 (Platform-independent configuration) that describes the modules that are important in the configuration step. In this section we have merged Section ... and Section ... 
\item Created Section 3.3 (Firmware generator) that describes the modules that are important in the generation step. In this section we have merged Section ... and Section ... 
\item Created Section 3.4 (Network monitoring) that describes the modules that are important in the monitoring step. In this section we have merged Section ... and Section ... 
\end{itemize}
