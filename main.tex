...
We conclude that we achieved our goal of creating a modular platform with a guiding design goal of being extendable in all possible aspects to facilitate use, reuse, and collaboration wider other community networks community.
While the platform provides minimal end-user features by itself, extendible base allows quick development of more features.
...
But instead of us developing all these new feature ourselves, the main next step is to engage other network communities to develop features specific to their networks.
We have already established partnerships with other community networks who are starting to work in this direction.

But we expect to see also completely new features.
