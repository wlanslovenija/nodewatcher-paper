...
Data collected through the \nodewatcher{} can be used in future research. \cite{Confine_2011}
Researchers could use analyze how community, wireless, or mesh networks operate through larger time spans.
Both on a technical level and also community and societal levels.
We are already using it to monitor KORUZA \cite{Mustafa_2013} deployments around the world and use it to guide further development and research in DIY free-optics connectivity.

Now that modular base has been made the real opportunities are opening.
While there will be many new features and modules made to further improve the networking aspects of community networks, we expect to see also completely new features.
