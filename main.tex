...
In old version of the platform, every new device was hard to support properly as it required substantial changes to the provisioning system code.
Additionally, it did not have advanced validation capabilities, resulting several times in erroneous configurations which required re-flashing to fix.
...
\todo[inline]{- further qualitative comparison v2 vs. v3}
