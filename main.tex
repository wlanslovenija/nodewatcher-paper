...
\begin{description}
    ...
    Note that supporting large single installations would most likely require optimizations in the monitoring modules.
    But since the whole monitoring pipeline is modular and designed to be easy to distribute over multiple servers, it can be improved upon by communities of such scale.
\end{description}
...
Further optimizations for really large networks.
