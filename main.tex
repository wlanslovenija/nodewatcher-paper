...
Geronimo       \newline (Opennet Initiative)   & \yes            & 2011     \newline 2011     & \no             & \no         & \no                      & \no                 & \yes     & \no                & \no           & \no         & \dynamic     & \yes     & \no           & \yes & \no                 & \no             & \maybe     & \no                & \yes               & PHP, Python           & Django       & none              \\ \hline
...
\begin{itemize}
\item We extended Django templating engine to allow modules to override or extend existing templates in a cascading way~\cite{Overextend_2013}.
