...
The design of datastream is modular, supporting implementations of additional\todo[inline]{alternative?} storage backends while continuing to expose the same API.
