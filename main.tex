...
\hline
\multirow{2}{*}{Project (Developers)} & \multicolumn{2}{c|}{General}                                   & \multicolumn{11}{c|}{Features}                                                                                                                                 & \multicolumn{6}{c|}{Modularity/Extensibility}                                          & \multicolumn{4}{c|}{Developer Accessibility}                                            \\ \cline{2-24} 
      & A & Y & NM & DG & FDR & CF & FW & API     & RA & LP & NA & TP & MP     & UI & API & NM & PL & SC  & RP & DOC & LAN    &  WF & LIC        \\ \hline
...
Additionally, we list whether the monitoring system supports providing automated network diagnostics based on stored node configuration (DG).
