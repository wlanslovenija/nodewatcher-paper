...
\begin{keyword}
community networks \sep provisioning \sep monitoring \sep deployment \sep management \sep wireless \sep mesh \sep collaboration
\end{keyword}
\end{frontmatter}
...
This process favors large and established network communities.
...
The modular approach makes extending the application easier, but in contrast to \nodewatcher{}, modularity ends there.
...
The design and development of the \nodewatcher{} platform comes from the needs and evolution of the \textit{wlan slovenija} community wireless network.
